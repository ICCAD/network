...
int main (int argc, char** argv)
{
	...
	int **network = new int *[1];
	double **flow_rate = new double *[1];
    ...
    do
    {
        ...
        /**********************************************************************/
            ...
            case TDICE_SIMULATE_SLOT :
            {
                ...
                SimResult_t result = emulate_slot (&tdata, stkd.Dimensions, &analysis, network, flow_rate) ;
        ...
        /**********************************************************************/
            ...
            case TDICE_SIMULATE_STEP :
            {
                ...
                SimResult_t result = emulate_step (&tdata, stkd.Dimensions, &analysis, network, flow_rate) ;
